...
function recarga_history(mes_pdfs, year_pdfs) {
    ...
    app.request.get(
        url + "/historial.php",
        { IdUsuario: IdU, mes_pdfs: mes_pdfs, year_pdfs: year_pdfs, tipo: tipo },
        function (data) {
...
function cargarDiesel() {
    ...
    if (localStorage.getItem("TipoAcceso") == "admin") {
        app.request.get(
            url + "/historial.php",
            { IdUsuario: IdU, tipo: tipo, empresa: id_empresa, Usuario: Usuario },
            function (data) {
                var content = JSON.parse(data);
                if (content == 0) {
...
function recarga_Diesel(mes_pdfs, year_pdfs) {
    ...
    if (localStorage.getItem("TipoAcceso") == "admin") {
        app.request.get(
            url + "/historial.php",
            { IdUsuario: IdU, tipo: tipo, empresa: id_empresa, mes_pdfs: mes_pdfs, year_pdfs: year_pdfs, Usuario: Usuario },
            function (data) {
                var content = JSON.parse(data);
                if (content == 0) {
