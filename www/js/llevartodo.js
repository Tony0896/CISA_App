                            ...
                            function (tx) {
                                tx.executeSql(
                                    ...
                                    function (tx, results) {
                                        ...
                                        for (var i = 0; i < length; i++) {
                                            var item1 = results.rows.item(i);
                                            var horas = item1.fecha.replace(
                                                " ",
                                                "T"
                                            );
                                            var horas2 = item1.fecha2.replace(
                                                " ",
                                                "T"
                                            );
                                                        ...
                                                        for (
                                                            ...
                                                            desincorporacionesD[
                                                                ...
                                                                UbicacionI:
                                                                    item2.UbicacionInc,
                                                                Incumplimiento:
                                                                    item2.Inclumplimiento,
                                                                OperadorD:
                                                                    item2.id_operador_des,
                                                                OperadorI:
                                                                    item2.id_operador_inc,
                                                                KmD: item2.KmDes,
                                                                KmI: item2.KmInc,
                                                                            ...
                                                                            Apoyos[
                                                                            ...
                                                                            ] =
                                                                                {
                                                                                    ...
                                                                                    Usuario:
                                                                                        item3.Usuario,
                                                                                    estatus_servidor:
                                                                                        item3.estatus_servidor,
                                                                                    id_operador:
                                                                                        item3.id_operador,
                                                                                    kilometrajeApoyo:
                                                                                        item3.kilometrajeApoyo,
                                                                                    kilometrajeUnidad:
                                                                                        item3.kilometrajeUnidad,
                                                                                };
                                                                        }
                                                                        $.ajax({
                                                                            type: "POST",
                                        ...
                                        for (var i = 0; i < length; i++) {
                                            ...
                                            datos_generales_recaudo[i] = {
                                                ...
                                                recaudo_sin_billetes:
                                                    item1.recaudo_sin_billetes,
                                                total_billetes:
                                                    item1.total_billetes,
                                                total_cacharpa:
                                                    item1.total_cacharpa,
                                                bolsas_totales:
                                                    item1.bolsas_totales,
                                                plomo: item1.plomo,
                                                monto1: item1.monto1,
                                                total_unidades:
                                                    item1.total_unidades,
                                                unidades_recaudads:
                                                    item1.unidades_recaudads,
                                                ...
                                                opc_adicional:
                                                    item1.opc_adicional,
                                                bolsaCacharpa10:
                                                    item1.bolsaCacharpa10,
                                                bolsaCacharpa20:
                                                    item1.bolsaCacharpa20,
                                                bolsaCacharpa50:
                                                    item1.bolsaCacharpa50,
                                                monto_adicional:
                                                    item1.monto_adicional,
                                        ...
                                        databaseHandler.db.transaction(
                                            function (tx) {
                                                tx.executeSql(
                                                    ...
                                                    function (tx, error) {
                                                        console.log(
                                                            "Error al consultar sanitizacion: " +
                                                                error.message
                                                        );
                                                    }
                                                );
            ...
            function (tx) {
                tx.executeSql(
                    ...
                    function (tx, results) {
                        ...
                        var urlphp =
                            url + "/guardarTrafico.php?tipo=" + estatus;
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: urlphp,
                            ...
                            data: {
                                desincorporaciones:
                                    JSON.stringify(desincorporaciones),
                            },
                            success: function (respuesta) {
                                                ...
                                                function (tx7) {
                                                    tx7.executeSql(
                                                        ...
                                                        [
                                                            ...
                                                            cerrado,
                                                            id_cedula,
                                                        ], // En servidor estado abierto y cerrado
                                                        function (
                                                            tx7,
                                                            results
                                                        ) {
            ...
            function (tx) {
                tx.executeSql(
                    ...
                    function (tx, results) {
                        ...
                        var estatus = item2.estatus_servidor;
                        var urlphp =
                            url + "/guardarTrafico_d.php?tipo=" + estatus;
                        ...
                        $.ajax({
                            ...
                            data: {
                                desincorporacionesd:
                                    JSON.stringify(desincorporacionesd),
                            },
                            success: function (respuesta) {
                                var respu1 = respuesta.split("._.");
                                var dat1 = respu1[0];
            ...
            function (tx) {
                tx.executeSql(
                    ...
                    function (tx, results) {
                        ...
                        var estatus = item2.estatus_servidor;
                        var urlphp =
                            url + "/guardarTraficoApoyo.php?tipo=" + estatus;
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: urlphp,
